...
// char maakKlimaatDataString() {
//         static int metingNummer = 1;
//         char a;
//         char result[3][33];
//         for(int plantenbak = 0; plantenbak < 3; plantenbak++) {
...
void loop() {
    ...
    // char teVerzenden = maakKlimaatDataString();
    ...
    for(int plantenbak = 0; plantenbak < 3; plantenbak++) {
        for(int variable = 0; variable < 33; variable++) {
            a = klimaatDataNu[plantenbak][variable];
            Serial.println("de verzonden char is");
            Serial.println(a);
            Mastereceive = SPI.transfer(a);
